  ...
  const plans = [
    {
      ...
      period: "/mês",
      description:
        "Para profissionais independentes (personal trainers, fisioterapeutas, nutricionistas)",
      features: [
        "Até 30 clientes",
        "Dashboard completo",
        "Controle financeiro",
    ...
    },
    {
      ...
      period: "/cliente/mês",
      description:
        "Para academias, clínicas e estúdios com múltiplos profissionais",
      features: [
        "Clientes ilimitados",
    ...
    <section id="pricing" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                {plan.highlighted && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-primary-600 text-white text-sm font-medium px-6 py-2 rounded-full">
                      Mais Popular
                    </div>
                  </div>
                )}
        ...
        <div className="mt-12 text-center">
          <div className="bg-primary-50 border border-primary-200 rounded-2xl p-6 max-w-2xl mx-auto">
